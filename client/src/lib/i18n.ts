...
const DICT = {
  en: {
    ...
    unseen_activity_label: "new",
    unseen_activity_tooltip: "New activity since you last viewed this recipe",
    saved_at: "Saved",
  ...
  zh: {
    ...
    status_draft: "草稿",
    status_approved: "已批准",
    unseen_activity_label: "新",
    unseen_activity_tooltip: "自上次查看以来的新活动",
    saved_at: "已保存",
    delete_recipe: "删除",
  ...
  th: {
    ...
    unseen_activity_label: "ใหม่",
    unseen_activity_tooltip: "กิจกรรมใหม่ตั้งแต่คุณดูล่าสุด",
